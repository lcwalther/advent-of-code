const passportInput = `iyr:2015 cid:189 ecl:oth byr:1947 hcl:#6c4ab1 eyr:2026
hgt:174cm
pid:526744288
...
function passportValidator(passportInput) {
  const formattedPassports = (passportInput) => {
    ...
    return passportsSplitByEmptyLine.reduce((obj, passport) => {
      const passportFields = passport.split(' ')
      const passwordObj = passportFields.reduce((object, field) => {
