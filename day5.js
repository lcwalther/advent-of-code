const boardingPassesInput = `FBBFBFBLRR
FBFFFFFLLR
FBBBBBBLLR
FFBFBBBRLL
FBBFFFFLRR
...
const getNumber = (characters) => {
  let lowerChar = 0
  let upperChar = characters.length > 3 ? 127 : 7
  for (let i = 0; i < characters.length; i++) {
    ;(characters[i] === 'F') | (characters[i] === 'L')
      ? (upperChar = upperChar - (upperChar - lowerChar + 1) / 2)
      : (lowerChar = lowerChar + (upperChar - lowerChar + 1) / 2)
